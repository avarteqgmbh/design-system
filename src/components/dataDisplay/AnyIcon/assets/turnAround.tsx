...
const turnAround: React.FC = () => {
  return (
    ...
    >
      <g id='Gruppe_1615' dataName='Gruppe 1615' transform='translate(0.002)'>
        <path
          id='Vereinigungsmenge_20'
          dataName='Vereinigungsmenge 20'
          d='M6074,9391.716V9352h0v-20h0v0h40v0h19.964A19.979,19.979,0,0,0,6114,9351.462v.54a20,20,0,0,1-20,20l-.007,0a19.979,19.979,0,0,0-19.99,19.712Z'
