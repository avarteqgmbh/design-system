...
const COLOR_PRIMARY_LIGHTER = '#AEB8D0'
const COLOR_PRIMARY_LIGHT = '#5D72A2'
const COLOR_PRIMARY_MAIN = '#0A2972'
const COLOR_PRIMARY_DARK = '#071B4B'
const COLOR_PRIMARY_DARKER = '#030E26'
