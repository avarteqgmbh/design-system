...
const COLOR_PRIMARY_LIGHTER = '#E9B2B9'
const COLOR_PRIMARY_LIGHT = '#D26573'
const COLOR_PRIMARY_MAIN = '#000000'
const COLOR_PRIMARY_DARK = '#7B0F1C'
const COLOR_PRIMARY_DARKER = '#3E070E'

const COLOR_ERROR_LIGHT = '#fba69e'
const COLOR_ERROR_MAIN = '#de2d0f'
const COLOR_ERROR_DARK = '#d63e30'
const COLOR_ERROR_CONTRAST = COLOR_COMMON_WHITE

const COLOR_SUCCESS_LIGHT = '#64f49e'
const COLOR_SUCCESS_MAIN = '#2b5c2b'
const COLOR_SUCCESS_DARK = '#259251'
const COLOR_SUCCESS_CONTRAST = COLOR_COMMON_WHITE

const COLOR_WARNING_LIGHT = '#ffde9d'
const COLOR_WARNING_MAIN = '#ffcc00'
